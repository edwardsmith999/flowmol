...
for ixyz = 1:3
    ...
    if (wallbot(ixyz) ~= 0)
        ...
        plot_cube(x,y,z,bot_wall_top,bot_wall_bot,[1, 0, 0],fig_cube)
    end
    % Top wall
    if (walltop(ixyz) ~= 0)
        ...
        plot_cube(x,y,z,top_wall_top,top_wall_bot,'blue',fig_cube)
    end
    ...
    if (thermstatbot(ixyz) ~= 0)
        ...
        plot_cube(x,y,z,bot_therm_top,bot_therm_bot,'yellow',fig_cube) 
    end
    ...
    if (thermstattop(ixyz) ~= 0)
        ...
        plot_cube(x,y,z,top_therm_top,top_therm_bot,'yellow',fig_cube) 
    end
    ...
    if (slidedistbot(ixyz) ~= 0)
        ...
        plot_slide(x,y,z,bot_slide_top,bot_slide_bot,wallslidev,fig_cube) 
    end
    %Top Sliding regions
    if (slidedisttop(ixyz) ~= 0)
        ...
        plot_slide(x,y,z,top_slide_top,top_slide_bot,wallslidev,fig_cube) 
    end
