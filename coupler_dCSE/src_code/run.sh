...
#mpiexec -n 1 xterm -geometry 150x20+1000+0 -hold -e ./couette_data/parallel.exe : -n $1 xterm -geometry 150x20+1000+220 -hold -e ./../../MD_dCSE/src_code/md.exe -i ./../../MD_dCSE/src_code/MD_coupled.in
