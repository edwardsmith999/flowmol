...
velocity_flux = reshape(vflux,gnbins(1),gnbins(2),gnbins(3),nd,Ncubeface,Nvflux_records);
fclose(fid);
%%
...
pressure_surface = reshape(psurface,gnbins(1),gnbins(2),gnbins(3),nd,Ncubeface,Nvflux_records);
fclose(fid);
%%
...
velocity_snapshot = reshape(vsnap,gnbins(1),gnbins(2),gnbins(3),nd,Nvflux_records+1);
fclose(fid);
%%
...
scatter(0:gnbins(1)-1,velocity_flux(:,randbin(2),randbin(3),1,1,4)+...
                        pressure_surface(:,randbin(2),randbin(3),1,1,4),'rx')
hold on
scatter(gnbins(1),velocity_flux(1,randbin(2),randbin(3),1,1,4)+...
                       pressure_surface(1,randbin(2),randbin(3),1,1,4),'rx')
scatter(1:gnbins(1),-velocity_flux(:,randbin(2),randbin(3),1,4,4)+...
