...
f = open('etevtcf','rb')							# Create binary file object
dble_filesize = int(os.path.getsize('etevtcf')/8)	# Number of double precisions in file
etevtcf = array('d')								# Initialise array of type double
