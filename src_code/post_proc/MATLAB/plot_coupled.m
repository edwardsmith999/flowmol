...
for i = 1:Nvel_records
    ...
    plot(xaxis(1:(gnbins(ixyz))),-mean(ave_vel_slice(:,1,m-t_ave/2:m+t_ave/2),3),'x','LineWidth',5,'Color',[.0 .5 .0],'MarkerSize',20);
    
    %plot(xaxis(1:(gnbins(ixyz))),continuum_velslice(2:ny+1,m)/u_0,'s','Color',[.5 .5 .5],'MarkerSize',20,'LineWidth',5);
